...
def asignacion_ya_existe(asignaciones, id_profesor, id_horario):
    ...
    for asignacion in asignaciones:
        ...
        if (
            ...
            and asignacion["id_profesor"] == id_profesor
            and asignacion["id_horario"] == id_horario
        ):
            return True
...
def asignar_horarios_profesores():
    ...
    if asignacion_ya_existe(
        asignaciones,
        id_profesor,
        id_horario
    ):
        print(
            "Este profesor ya tiene asignado ese horario."
        )
        return

    nueva_asignacion = {
        "id_asignacion_horario": generar_id(
            asignaciones,
