...
def ver_notas_unidad():
    ...
    if not notas:
        ...
        return
    unidades = sorted(list(set(nota["id_unidad"] for nota in notas if nota["estado"] == "Activo")))
    ...
    try:
        ...
        return
    resultados = [nota for nota in notas if (nota["estado"] == "Activo" and nota["id_unidad"] == id_unidad)]
    if len(resultados) == 0:
