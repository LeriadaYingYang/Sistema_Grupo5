...
def mostrar_carreras(carreras, id_carrera_plantilla):
    print("\n=== CARRERA DE LA PLANTILLA ===")
    for carrera in carreras:
        if (
            carrera["estado"] == "Activo"
            and carrera["id_carrera"] == id_carrera_plantilla):
...
def pedir_detalle_horario():
    ...
    for i in range(1, cantidad + 1):
        ...
        hora_fin = input("Hora de salida (ejemplo 12:00): ")
