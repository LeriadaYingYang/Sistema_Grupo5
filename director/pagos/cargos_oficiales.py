...
def desactivar_o_cambiar_estado_cargo(cargo, cargos_lista):
    """Realiza el cambio de estado (borrado lógico) de un cargo oficial."""
    if cargo["estado"] == "Activo":
        cargo["estado"] = "Inactivo"
        print(f"\n El cargo '{cargo['nombre_cargo']}' ha sido DESACTIVADO (Inactivo).")
    else:
        cargo["estado"] = "Activo"
        print(f"\n El cargo '{cargo['nombre_cargo']}' ha sido ACTIVADO nuevamente.")
