...
def obtener_modulos(modulos, id_unidad):
    resultado = []
...
def buscar_registro(notas, id_alumno, id_unidad, id_modulo):
...
def obtener_alumnos(notas, id_carrera, id_salon, id_unidad):
    alumnos = []
...
def ver_notas_por_unidad():
    ...
    for alumno in [alumno_elegido]:
        print("\n--------------------------------------")
        print(f"Alumno: {alumno['nombre_alumno']}")
