...
def reactivar_matricula():
    ...
    print(
        "Matrícula reactivada correctamente."
    )
...
def menu_retirar_matricula():
    ...
    while True:
        ...
        match opcion:
            ...
            case "3":
                mostrar_historial_retiros()

            case "4":
                buscar_retiro_por_id()
