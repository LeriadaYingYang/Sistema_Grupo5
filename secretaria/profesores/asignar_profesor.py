...
def mostrar_profesores(profesores):  # Muestra profesores activos disponibles para asignar
...
#Controlando errores de entrada
    try:
        id_profesor = int(input("\nIngresar ID del profesor: "))
    except ValueError:
    ...
    if ya_existe_asignacion(asignaciones, id_profesor, id_salon):
        print("Este profesor ya está asignado al salón.")
        return
    nueva_asignacion = {
