...
def calcular_monto_final(monto, descuento):  #Calcula el monto final luego de un descuento o convenio
...
#Controlando errores de entrada para ID de plantilla
    try:
...
#Controlando errores de entrada para ID de salón
    try:
...
#Controlando errores de entrada para ID de alumno
    try:
...
#Controlando errores de entrada para ID de cargo oficial
    try:
        id_cargo = int(input("\nIngresar ID del cargo oficial: "))
    except ValueError:
        print("Debe ingresar un número.")
        return
...
#Controlando errores de entrada para ID de descuento o convenio
    try:
        id_descuento = int(input("\nIngresar ID del descuento/convenio: "))
    except ValueError:
        print("Debe ingresar un número.")
        return
